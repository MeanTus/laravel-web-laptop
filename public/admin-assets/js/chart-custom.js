...
if (jQuery("#layout1-chart-02").length) {
  var options = {
    ...
    name: 'Website Blog',
    type: 'column',
    data: [300, 450, 280, 250, 220, 180, 150, 120]
  }, {
    name: 'Social Media',
    type: 'line',
  ...
  yaxis: [{
    ...
    (chart = new ApexCharts(document.querySelector("#layout1-chart-02"), options)).render()
    const body = document.querySelector('body')
    if (body.classList.contains('dark')) {
      apexChartUpdate(chart, {
        dark: true
...
if(jQuery('#layout1-chart-2').length){
  ...
  if (jQuery("#layout1-chart-5").length) {
    ...
    //     {
    //       name: 'Total Likes',
    //       data: [86, 80, 84, 95, 83, 100, 88, 76, 86, 93, 85, 100]
    //     }, 
    //     {
    //       name: 'Total Share',
    //       data: [76, 72, 76, 85, 74, 69, 80, 68, 78, 85, 77, 55]
